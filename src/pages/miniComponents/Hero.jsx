  ...
  useEffect(() => {
    const getMyProfile = async () => {
      const { data } = await axios.get(
        "https://website-backend-coral.vercel.app/api/v1/user/portfolio/me",
  ...
  return (
    <div className="w-full">
      ...
      sm:text-[1.75rem] md:text-[2.2rem] lg:text-[2.8rem] tracking-[15px]">
        <Typewriter
          words={["Engineer", "Web Developer", "Freelancer", "Teacher", "Material Researcher", "Technology enthusiast", "Sales Expert"]}
          loop={50}
          cursor
          typeSpeed={70}
          deleteSpeed={50}
      ...
      items-center mt-4 md:mt-8 lg:mt-10">
        <Link to={"https://www.youtube.com/@mr.explorer3480"} target="_blank">
        ...
        <Link to={user.githubURL} target="_blank">
          <Github className="text-purple-800 w-7 h-7" />
        </Link>
      </div>
      <div className="mt-4 md:mt-8 lg:mt-10  flex gap-3">
        <Link to={"https://wa.me/" + user.phone + "/?text=Hi,%20Shovan"} target="_blank">
