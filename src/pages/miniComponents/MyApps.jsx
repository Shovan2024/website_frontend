...
const MyApps = () => {
  ...
  useEffect(() => {
    const getMyApps = async () => {
      const { data } = await axios.get(
        "https://websitebackend-production-7b1e.up.railway.app/api/v1/softwareapplication/getall",
  ...
  return (
    <div className="w-full flex flex-col gap-8 sm:gap-12 overflow-x-hidden">
      ...
      <h1 
          ...
          style={{
            background: "hsl(222.2 84% 4.9%)",
                ...
                >
        <span className="text-tubeLight-effect font-extrabold"> SOFTWARE</span>
        <span className="absolute w-full h-1 top-7 sm:top-7 md:top-8 lg:top-11 z-[-1] bg-slate-200"></span>
      </h1>
      </div>
